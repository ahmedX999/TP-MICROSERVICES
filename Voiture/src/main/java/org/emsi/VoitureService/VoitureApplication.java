...
public class VoitureApplication {
	...
	public CommandLineRunner initializeDatabase(
		...
		return args -> {
			...
			voitureRepository.save(new Voiture(Long.parseLong("1"), "Mercedes", "A 26 9292", "Benz", 1L, c2));
			voitureRepository.save(new Voiture(Long.parseLong("2"), "Renault", "B 6 2992", "Megane", 1L, c2));
			voitureRepository.save(new Voiture(Long.parseLong("3"), "Dacia", "A 33 3300", "Duster", 2L, c1));
		};
	}
